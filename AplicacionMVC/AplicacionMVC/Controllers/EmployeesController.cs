...
namespace AplicacionMVC.Controllers
{
    ...
    {
        private readonly OptimacorpContext _context;

        public EmployeesController(OptimacorpContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["IdDeparmentFk"] = new SelectList(_context.Departments, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Salary,IdDeparmentFk")] Employee employee)
        {
            ...
            ViewData["IdDeparmentFk"] = new SelectList(_context.Departments, "Id", "Id", employee.IdDeparmentFk);
            return View(employee);
        }
